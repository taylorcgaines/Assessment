...
/*************************************************************************************
------------ ANSWER -------------------
console x: I'm a local variable.
console.y: Undefined, because it is declared in a function.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) will return undefined, because its initialized due to the hoisting, but it hasn't had anything assigned to it yet. Because the function gets hoisted all together, its already "returned" the "function hoisting"
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
inside, it will say 4; outside it is undefined, because we initialized it in the body of a function.
**************************************************************************************/
